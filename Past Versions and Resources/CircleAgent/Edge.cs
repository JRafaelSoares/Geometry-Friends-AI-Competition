namespace GeometryFriendsAgents
{
    ...
    internal class Edge
    {
        public CVector2 posPlatform_1;
        public CVector2 posPlatform_2;
        ...
        public Edge(CVector2 vec_st, CVector2 vec_ed)
        {
            this.platform_1 = -1;
            this.platform_2 = -1;
            this.posPlatform_1 = vec_st;
            this.posPlatform_2 = vec_ed;
        }

        public Edge(float x1, float y1, float x2, float y2, int in_platform_1, int in_platform_2)
        {
            this.posPlatform_1 = new CVector2(x1, y1);
            this.posPlatform_2 = new CVector2(x2, y2);
        ...
        {
            CVector2[] vectorArray = nearraytoline(new CVector2(this.posPlatform_2 - this.posPlatform_1), new CVector2(in_edge.posPlatform_1 - this.posPlatform_1), new CVector2(in_edge.posPlatform_2 - this.posPlatform_1));
            if (vectorArray == null)
            {
                return null;
            }
            CVector2 pt = vectorArray[0];
            pt.add(this.posPlatform_1);
            if (!this.col_PointtoBox(pt, this.posPlatform_1, this.posPlatform_2) || !this.col_PointtoBox(pt, in_edge.posPlatform_1, in_edge.posPlatform_2))
            {
                return null;
            }
            return pt;
        ...
        public float length() => 
            (this.posPlatform_2 - this.posPlatform_1).length();
