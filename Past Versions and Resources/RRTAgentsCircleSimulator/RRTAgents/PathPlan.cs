            ...
            if (pathPoints.Count != 0) {
                ...
                for (int i = 0; i < pathPoints.Count; i++)
                {
                    ...
                    for(int j = pathPoints.Count - 1; j > i; j--)
                    {
                        ...
                        {
                            //if the platform is the same and there is no other blocking the way nor it is a jump and this (i) was not the state where the diamond was caught
                            ...
                            if(platformJ != null && platformI != null &&
                                ...
                                i > 0 && pathPoints[i-1].getUncaughtColl().Count == pathPoints[i].getUncaughtColl().Count)
                            {
