...
namespace GeometryFriendsAgents
{
    public class RectangleAgent : AbstractRectangleAgent
    {
        ...
        private RectangleMultiplayer multiPlayer;
        ...
        public override void Setup(CountInformation nI, RectangleRepresentation rI, CircleRepresentation cI, ObstacleRepresentation[] oI, ObstacleRepresentation[] rPI, ObstacleRepresentation[] cPI, CollectibleRepresentation[] colI, Rectangle area, double timeLimit, float gameSpeed)
        {
            ...
            {
                gameMode = 1;
                multiPlayer = new RectangleMultiplayer(false, testing, timer);
